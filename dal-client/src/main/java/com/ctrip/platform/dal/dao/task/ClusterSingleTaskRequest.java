...
public class ClusterSingleTaskRequest<T> implements DalRequest<int[]> {
...
//    private String logicDbName;
    ...
    private ClusterSingleTaskRequest(String logicDbName, DalHints hints, SingleTask<T> task) {
//        this.logicDbName = logicDbName;
    ...
    public ClusterSingleTaskRequest(String logicDbName, DalHints hints, T rawPojo, SingleTask<T> task) {
    ...
    public ClusterSingleTaskRequest(String logicDbName, DalHints hints, List<T> rawPojos, SingleTask<T> task) {
        this(logicDbName, hints, task);
...
//        detectDistributedTransaction(logicDbName, hints, daoPojos);
    ...
    public Callable<int[]> createTask() {
        return new ClusterSingleTaskRequest.SingleTaskCallable<>(hints, daoPojos, rawPojos, task, dalTaskContext);
    }
